...
<section class="profile_sec">
	...
	<div class="container">
		...
		@foreach($ptsa->where('section_title', 'ptsa')->get() as $ross)	
...
<script>
    $(document).ready(function(){
       ...
       $('.page_inner>table').css({'margin-top': '31px', 'display': 'inline-table'});            
//       $('.page_inner>ul>li:first-child').addClass('princi_head');         
    });
</script>
